...
import static com.github.openhab.language.items.psi.ItemsTypes.*;
...
WHITE_SPACE=\s
END_OF_LINE_COMMENT=("#"|"!")[^\r\n]*
ITEM_TYPE_KEYWORD=("Color"|"Contact"|"DateTime"|"Dimmer"|"Group"|"Image"|"Location"|"Number"|"Player"|"Rollershutter"|"String"|"Switch")
